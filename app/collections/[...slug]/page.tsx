...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!item) {
    return { title: 'Product Line Not Found | Furniture' }
  }
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                ...
                <dl className="space-y-4">
                  {(item as any).tagline && (
                    <div>
                      <dt className="text-sm text-gray-500">Tagline</dt>
                      <dd className="font-semibold text-gray-900">{(item as any).tagline}</dd>
                    </div>
                  )}
                  ...
                  {(item as any).style && (
                    <div>
                      ...
                      <dd className="font-semibold text-gray-900">{(item as any).style}</dd>
                    </div>
                  )}
                </dl>
                <div className="mt-8">
