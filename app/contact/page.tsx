...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Visit our Burlington, Vermont showroom or contact Hearthwood Furniture for custom orders, design consultations, and delivery inquiries.',
  keywords: ['Contact Furniture Store', 'Custom Furniture', 'Showroom Visit', 'Design Consultation'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Interested in a custom piece or want to visit our showroom? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@craftwoodfurniture.com</p>
                    <p className="text-gray-600">support@craftwoodfurniture.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 901-2314</p>
